...
export function NuevoIngresoView({
  ...
  // Sin valor por defecto a propósito: «compra» y «consignación» pagan en
  // momentos distintos, así que el usuario tiene que elegirlo explícitamente.
    ...
    return [
      {
        nombre: prod.nombre,
        cantidad: '1',
        costoUnitario: prod.costo_vigente != null ? String(prod.costo_vigente) : '',
        esNuevo: false,
